...
const ADMIN_EMAIL = process.env.ADMIN_EMAIL || 'beksultan.alimbek@gmail.com'; // User's email or fallback
...
router.post('/', async (req, res) => {
  try {
    ...
    // Send email to admin
    await sendEmail({
      to: ADMIN_EMAIL, // We send contact requests to the site admin
